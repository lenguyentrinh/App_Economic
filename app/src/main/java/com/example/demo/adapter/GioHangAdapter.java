...
import com.example.demo.Interface.ImageClickListener;
import com.example.demo.R;
import com.example.demo.model.EventBus.TinhTongEvent;
            ...
            public void onImageClick(View view, int pos, int giatri) {
                if(giatri == 1){
                    if(gioHangList.get(pos).getSoluong()>1){
                        ...
                        builder.setMessage("Are you sure you want to remove this product from your cart?");
